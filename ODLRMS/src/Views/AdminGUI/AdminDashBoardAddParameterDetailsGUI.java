...
public class AdminDashBoardAddParameterDetailsGUI extends javax.swing.JFrame {
            ...
            if(con != null) {
                try {
                    ...
                    if(!isAlreadyNamePresent()){
                        ...
                        JOptionPane.showMessageDialog(null, "Already This Name Parameter added");
                }
                catch(Exception ex) {
                    JOptionPane.showMessageDialog(null, ex.getMessage());
                }               
    ...
    private boolean isAlreadyNamePresent() {
        if(con != null) {
            try {
                ps = con.prepareStatement("SELECT name FROM `test_details` where t_id = ?");
                ps.setInt(1,Integer.valueOf(selected_ID));
                rs = ps.executeQuery();
                while(rs.next()) {
