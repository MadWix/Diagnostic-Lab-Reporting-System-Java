...
public class PatientDashBoardAppointmentGUI2 extends javax.swing.JFrame {
        ...
        if(con != null) {
            try {
                ...
                if(!isAlreadyAppointment()){
                    ...
                    JOptionPane.showMessageDialog(null, "Already You Book Another Appointment Of This Date And Time");
            }
        catch(Exception ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
    ...
    private boolean isAlreadyAppointment() {
        if(con != null) {
            try {
                
                ps = con.prepareStatement("Select date,time from appointment where p_id = ? ");
                ...
                while(rs.next()) {
                    if(rs.getString(1).equals(PatientDashBoardAppointmentGUI.date) && rs.getString(2).equals(PatientDashBoardAppointmentGUI.time))
                        return true;
                }
            }
            catch(Exception ex) {
